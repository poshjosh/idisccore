...
public class WebFeedCrawler extends WebCrawler<Integer> {
    
  private transient static final Class cls = WebFeedCrawler.class;
  ...
  public WebFeedCrawler(
    ...
    logger.log(Level.FINE, "Done creating: {0}", cls, WebFeedCrawler.this);
...
//                config.getString(new Object[] { "url", "value" }), // Images may not start with baseUrl
  ...
  public String getTaskName() {
    return "WebFeedCrawler for " + this.getContext().getConfig().getName();
  }
}
