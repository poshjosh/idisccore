...
import com.idisc.core.extraction.ExtractionContextImpl;
...
public class ExtractionContextForWebPages extends ExtractionContextImpl {
    ...
    public ExtractionContextForWebPages(
        JpaContext jpaContext, CapturerContextFactory configFactory, Configuration config) {
        super(Collections.unmodifiableList(
                        new ArrayList(configFactory.getConfigService().getConfigNamesLessDefaultConfig())    
                ),
                new GetSubList(),
    ...
    public ExtractionContextForWebPages(
        ...
        CapturerContextFactory configFactory, Configuration config) {
        super(names,
                new GetSubList(),
                new WebFeedTaskProvider(jpaContext, configFactory, config)
        );
