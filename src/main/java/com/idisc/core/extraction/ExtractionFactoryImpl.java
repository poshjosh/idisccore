...
import com.idisc.core.extraction.rss.ExtractionContextForRss;
...
public class ExtractionFactoryImpl implements ExtractionFactory {
    ...
    public ExtractionContext createExtractionContext(String key) {
        ...
        switch(key) {
            ...
            case "web":
                final CapturerContextFactory configFactory = app.getScrapperContextFactory();
    ...
    public Collection<String> getNames(String key) {
        ...
        switch(key) {
            ...
            case "web":
                final JsonConfigService configService = app.getScrapperContextFactory().getConfigService();
                sitenames = new ArrayList(
                        configService.getConfigNamesLessDefaultConfig()
                );
                break;
