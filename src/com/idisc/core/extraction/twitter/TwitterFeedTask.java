...
import com.scrapper.ResumableCrawler;
...
public class TwitterFeedTask extends AbstractStoppableTask<Collection<Feed>> implements Serializable {
  ...
  private final class ResumableUrlParserImpl extends ResumableCrawler implements AutoCloseable {
  ...
  private boolean updateFeedWithDirectContent(
      Feed feed, String link, ResumableCrawler parser, 
    ...
    try {
      ...
      Set<String> sites = cf.getConfigNames();
      ...
      HtmlDocument pageNodes = new HtmlDocumentImpl(link, nodeList);
