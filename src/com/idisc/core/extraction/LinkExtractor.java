...
public class LinkExtractor implements Function<HtmlDocument, Set<String>> {
    ...
    @Override
    public Set<String> apply(HtmlDocument doc) {
        
        final NodeList linkNodes = doc.getElements(linkNodeFilter);
        ...
        logger.finer(() -> "  URL: " + doc.getURL() + ", Links collected: " + links.size());
        logger.finest(() -> "  URL: " + doc.getURL() + ", Links collected: \n" + toString().replace(", ", "\n"));
