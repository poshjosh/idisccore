...
public class WebFeedCreator extends FeedCreator {
  ...
  public Feed createFeed(HtmlDocument pageNodes, Date dateCreatedIfNone){
    ...
    public void updateFeed(Feed feed, HtmlDocument dom, Date dateCreatedIfNone) {
...
Class cls = this.getClass();
        ...
        final Map defaults = context.getNodeExtractorConfig().getDefaults();
